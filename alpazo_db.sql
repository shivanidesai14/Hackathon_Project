...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 04, 2019 at 06:41 PM
...
CREATE TABLE `services` (
  ...
  `service-icon` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `services` (`service_id`, `service_name`, `service-icon`) VALUES
(1, 'Yoga Trainer', ''),
(2, 'Fitness Trainer', ''),
(3, 'Tv Repair', ''),
(4, 'Ro Water Purifyer', ''),
...
(1, 'Fenil', 'fenil@gmail.com', '12345', '9409407344', 1, '3/4 vitrag society,p.t. college road,paldi,\r\nahmedabad', 380007),
